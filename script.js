...
function renderSidebar(){
  document.getElementById("workspaceLabel").textContent = `Calendario — ${WORKSPACES[state.workspace]}`;
...
document.getElementById("clearBtn").addEventListener("click", () => {
  if(!confirm(`Esto borrará todas las fechas pintadas y etiquetas de "${WORKSPACES[state.workspace]}". ¿Continuar?`)) return;
